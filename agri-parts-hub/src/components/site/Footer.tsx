  ...
  return (
    <footer className="surface-steel">
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-14 md:grid-cols-3">
        <div>
          <p className="font-display text-2xl font-extrabold">PCM srl</p>
          <p className="mt-3 text-sm opacity-70">
            Ricambi e assistenza per mietitrebbie, trattori e oleodinamica dal 2001.
          </p>
        ...
        <div className="text-sm opacity-80">
          ...
          <p className="mt-2 opacity-60">Zona autoportuale, 200 m dal casello A14</p>
        </div>
        <div className="text-sm opacity-80">
          ...
          <p className="mt-2 opacity-60">Lun–Ven 8:00–13:00 / 15:00–18:30 · Sab su appuntamento</p>
        </div>
      </div>
